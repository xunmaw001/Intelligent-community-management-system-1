...
public class TousuchuliController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,TousuchuliEntity tousuchuli, HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("zhuhu")) {
			tousuchuli.setZhuhuzhanghao((String)request.getSession().getAttribute("username"));
		}
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,TousuchuliEntity tousuchuli, HttpServletRequest request){
        EntityWrapper<TousuchuliEntity> ew = new EntityWrapper<TousuchuliEntity>();
    	PageUtils page = tousuchuliService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, tousuchuli), params), params));
		request.setAttribute("data", page);
        return R.ok().put("data", page);
