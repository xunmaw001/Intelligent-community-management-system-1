...
public class ZhuhuController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,ZhuhuEntity zhuhu, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,ZhuhuEntity zhuhu, HttpServletRequest request){
        EntityWrapper<ZhuhuEntity> ew = new EntityWrapper<ZhuhuEntity>();
    	PageUtils page = zhuhuService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, zhuhu), params), params));
		request.setAttribute("data", page);
        return R.ok().put("data", page);
