...
<body>
					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑物业费</span></li>
							</ol>
						</div>
					</div>
				</div>
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>缴费名称</label>
										<input id="jiaofeimingcheng" name="jiaofeimingcheng" class="form-control" placeholder="缴费名称">
									</div>
									<div class="form-group col-md-6">
										<label>月份</label>
	...
	<script>
		...
		function dataBind(){
			...
			$("#jiaofeimingcheng").val(ruleForm.jiaofeimingcheng);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.jiaofeimingcheng != null && res.data.jiaofeimingcheng != ''){

					$("#jiaofeimingcheng").val(res.data.jiaofeimingcheng);
					}
