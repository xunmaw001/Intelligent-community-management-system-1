...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">投诉反馈管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>投诉反馈管理</span></li>
								<li class="breadcrumb-item active"><span>投诉反馈列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">投诉反馈列表</h3>							
	...
	<script>
		...
		function setDataRow(item,number){
            ...
            crossBtn1.innerHTML = "处理"
			crossBtn1.setAttribute("type","button");
			crossBtn1.setAttribute("class","btn btn-primary btn-sm");
			crossBtn1.setAttribute("onclick","crossTable(" + item.id + ",\"tousuchuli\")");
			if(crossBtnControl('处理') == true){
		...
		function sh(){
			...
			httpJson("tousufankui/update","POST",data,(res)=>{
				if(res.code == 0){
					$('#addRowModal').hide();
					alert("提交成功");
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("tousufankui/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"tousufankui");
