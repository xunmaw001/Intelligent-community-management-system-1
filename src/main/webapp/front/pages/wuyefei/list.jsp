        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-fff">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">物业费展示</span><span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
            </div>
            ...
            <form class="layui-form">
              <div class="layui-inline" style="margin-bottom: 10px;">
                ...
                <div class="layui-input-inline">
                  <input type="text" name="jiaofeimingcheng" id="jiaofeimingcheng" placeholder="缴费名称" autocomplete="off" class="layui-input">
                </div>
              </div>   
              <div class="layui-inline" style="margin-bottom: 10px;">
              ...
              <div class="layui-inline" style="margin-bottom: 10px;">
                ...
                <div class="layui-input-inline">
                  <input type="text" name="zhuhuzhanghao" id="zhuhuzhanghao" placeholder="住户账号" autocomplete="off" class="layui-input">
                </div>
              </div>   
              <div class="layui-inline" style="margin-bottom: 10px;">
                <label class="layui-form-label">楼房号</label>
                <div class="layui-input-inline">
                  <input type="text" name="loufanghao" id="loufanghao" placeholder="楼房号" autocomplete="off" class="layui-input">
                </div>
              </div>   
              <div class="layui-inline" style="margin-left: 30px;margin-bottom: 10px;">
                ...
                <button v-if="isAuth('wuyefei','新增')" @click="jump('../wuyefei/add.jsp')" type="button" class="layui-btn btn-theme">
              ...
              <ul>
                <li v-for="(item,index) in dataList" v-bind:key="index">
                  <div class="ng-prslist-doc">
                    <div class="ng-prslist-img" @click="jump('../wuyefei/detail.jsp?id='+item.id)">
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#jiaofeimingcheng').val()) {
          param['jiaofeimingcheng'] = jquery('#jiaofeimingcheng').val() ? '%' + jquery('#jiaofeimingcheng').val() + '%' : '';
        }  
        ...
        if (jquery('#loufanghao').val()) {
          param['loufanghao'] = jquery('#loufanghao').val() ? '%' + jquery('#loufanghao').val() + '%' : '';
        }  
        // 获取列表数据
        http.request('wuyefei/list', 'get', param, function(res) {
