				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('huodongxinxi','报名')" @click="onAcrossTap('huodongbaoming')" type="button" class="layui-btn">
								报名
							</button>
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					...
					vue.detail = res.data
															vue.title = vue.detail.huodongbiaoti;
																														// 轮播图片
					vue.swiperList = vue.detail.fengmiantu ? vue.detail.fengmiantu.split(",") : [];
																																																																	var swiperItemHtml = '';
